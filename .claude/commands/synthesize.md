...
Read the output. If ARGUMANLAR.md is empty, tell the user to add arguments first and stop.

## Step 2 — Present the synthesis scaffold

Read SENTEZ.md and display it to the user section by section.
...
For each 📝 Sentez Alanı section in SENTEZ.md, guide the user:
