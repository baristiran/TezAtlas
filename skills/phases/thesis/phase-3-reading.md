...
After reading saturation is reached, choose your research methodology:

**Theoretical / Conceptual Research** → proceed directly to Phase 4 (Structure)

**Empirical Research** → complete the following before Phase 4:
...
### Mixed Methods
- Complete both paths above in sequence or parallel
- Integration point: explain how qualitative findings inform quantitative hypotheses (or vice versa)
