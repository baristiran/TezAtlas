...
- `/synthesize` — Multi-source synthesis: map notes → arguments → SENTEZ.md
...
- `scripts/contradiction_scan.py` — Cross-source contradiction detection → CELISKILER.md
...
- `scripts/synthesize.py` — Multi-source synthesis scaffold → SENTEZ.md
