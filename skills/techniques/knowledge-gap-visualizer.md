...
**Önkoşul:** CAW (Cognitive Augmentation Workspace) aktif ve `ARGUMANLAR.md` güncel.
...
## ARGUMANLAR.md ile Entegrasyon

Knowledge Gap Visualizer, `ARGUMANLAR.md`'den verileri okur ve günceller:
