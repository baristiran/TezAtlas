...
- **Thesis/Dissertation:** Faculty advisor — formal checkpoints at each phase gate
- **Journal Article:** Co-author(s) or senior colleague — review before submission and after major revision
- **Conference Paper:** At minimum: one colleague reads the draft before submission
- **Literature Review:** Systematic review requires independent screener for Phases 1-2 (inter-rater reliability)
- **Research Report:** Client / project lead / commissioning organization — approve scope (Phase 0) and findings (Phase 3)
- **Book Chapter:** Volume editor — approve outline (Phase 0) and full draft (Phase 4)

The spirit: no major decision is made in isolation. Human review is mandatory at gates.
