...
node_type: tooling
description: "One-command project bootstrap: creates STATUS.md, READING_REPORT.md, ARGUMANLAR.md, sources/, notes/, discipline-specific templates. Fast-path for experienced users who already know their parameters."
description_tr: "Tek komutla proje başlatma: STATUS.md, READING_REPORT.md, ARGUMANLAR.md, sources/, notes/, disipline özgü şablonlar oluşturur. Parametrelerini bilen deneyimli kullanıcılar için hızlı yol."
