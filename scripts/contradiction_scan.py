...
Kullanım:
    ...
    python3 scripts/contradiction_scan.py --output CELISKILER.md

Çıktı: CELISKILER.md — Claude'un incelemesi için çelişki adayları
"""
...
def write_report(
    ...
    if not contradictions:
        ...
        for i, c in enumerate(contradictions, 1):
            ...
            lines += [
                ...
                "- Bu çelişkiyi ARGUMANLAR.md'e eklemeli misin?",
                "",
            ]
    ...
    lines += [
        ...
        "2. Gerçek çelişkileri ARGUMANLAR.md'e ekle",
...
def main() -> None:
    ...
    parser.add_argument(
        "--output", metavar="FILE", default="CELISKILER.md",
        help="Çıktı rapor dosyası (varsayılan: CELISKILER.md)",
    )
    parser.add_argument(
    ...
    if contradictions:
        ...
        print("📋 CELISKILER.md dosyasını Claude ile incele:")
