...
ARGUMANLAR.md'deki her argümanın kaynak kapsama oranını hesaplar.
...
# ── ARGUMANLAR.md parser ──────────────────────────────────────────────────────

def parse_argumanlar(path: Path) -> list[dict]:
    """
    ARGUMANLAR.md tablosunu parse eder.
    Tablo formatı:
...
def main() -> None:
    ...
    print(f"📋 {len(arguments)} argüman yüklendi (ARGUMANLAR.md)")
